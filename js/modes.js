var modes = [
  {
    ...
    places: [
      ...
      }, 
	  {
        ...
        name: "Hinton James Hall", 
        text: "Josh: Hey! I’m Josh! I’ll be your RA for the year! Hojo rocks! ha ha! Don’t worry about what the upperclassmen say! This is THE place to be! Now it kinda looks like you’ve started a fire in the lounge here. That’s cool though, dude!! Don’t worry! Just, we should probably get out of here! Like super fast! So catch you at the exit! And hopefully at the sand volleyball tournament tomorrow! Wackiest volleyball shorts win a prize! And you look pretty wacky! Ha ha nah man I’m just playing, you seem cool! Op, looks like the fire department is coming, let’s head to the exit!!! <br><b> Navigate through HoJo to find me at the exit before the fire gets you!",
	  ...
	  {
        name: "Kenan Stadium", 
        text: "Gio Bernard:  <br><b> INSTRUCTIONS",
...

	  {
        ...
        name: "Old Well", 
        text: "Ramses: Congratulations! You have officially earned a bachelor of science in Explorolinology! There’s no game this time, just the sweet satisfaction of knowing you have completed your first step in becoming a true Tar Heel, born, bred, and dead. Go heels!",
