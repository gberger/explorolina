var modes = [
  {
    ...
    places: [
	  ...
	  {
        name: "Dean Dome", 
        text: "<b>Michael Jordan: </b>Hey, I'm Michael Jordan, but you already knew that. To move on to the next stage of this game, you're gonna have to do something that no one has done before: outshoot me. You'll have to make at least 10 free throws in 30 seconds. Oh, and if you were wondering, I averaged 83% from the line. Good luck with this one. <b> Shoot balls by XXXX Ready, set, GO",
		img: "<br><br><img src = './img/jordan.png' height = 30% width = 30%>",
		button: "play",		
		lat: 35.899446, 
        lng: -79.043976
      }, {
        name: "Hinton James Hall", 
        text: "<b>Hinton James: </b>Hi, my name is Hinton James. I was the first student to attend the University of North Carolina when it opened its doors as the US's first public university in 1789. I was so excited to attend classes here that I walked all the way from Wilmington, North Carolina. That's about 160 miles, but who's counting? How'd you get here? Oh looks like it was your mom's SUV, hm, that's cool too. This is the residence hall that’s named after me: Hinton James Hall. We’re on South campus right now, just about as far South as you can get, housing wise. But over 900 students live here, mostly freshmen! If you live here, you’ll definitely make loads of friends! They don’t call me howdy-neighbor Hinton for nothing! Ha, just kidding, don’t call me that. I'm going to go check out if they've trimmed the tree branch that was blocking my plaque now, but why don't you get to know some of your new hallmates by making some popcorn to share in the lounge! <br><b> Make popcorn by tapping/clicking on the microwave! The faster you tap, the more popcorn you’ll make to share with your friends!",
		img: "<br><br><img src = './img/hintonjames.png' height = 30% width = 30%>",
		button: "make some popcorn",		
		lat: 35.902304, 
        lng: -79.043451
      },{
        name: "Hinton James Hall", 
        text: "<b>Josh: </b>Hey! I’m Josh! I’ll be your RA for the year! Hojo rocks! ha ha! Don’t worry about what the upperclassmen say! This is THE place to be! Now it kinda looks like you’ve started a fire in the lounge here. That’s cool though, dude!! Don’t worry! Just, we should probably get out of here! Like super fast! So catch you at the exit! And hopefully at the sand volleyball tournament tomorrow! Wackiest volleyball shorts win a prize! And you look pretty wacky! Ha ha nah man I’m just playing, you seem cool! Op, looks like the fire department is coming, let’s head to the exit!!! <br><b> Navigate through HoJo by using tapping the screen to find Josh at the exit before the fire gets you!",
		img: "<br><br><img src = './img/ra.png' height = 30% width = 30%>",
		button: "escape",		
		lat: 35.902304, 
        lng: -79.043451
      }, {
        name: "Kenan Stadium", 
        text: "<b>Charlie 'Choo Choo' Justice: </b>Hi My name is Charlie Justice and during my years here at Carolina, people started calling me Choo Choo, because of the way I dodged tackles and looked like a runaway train. Anyways, enough about me. Let's talk about the wonderful tradition of football at Carolina. While we do have one of the best basketball programs in the country, football isn't that bad either. We had a few good guys like Dre Bly, Julius Peppers, Johnathan Cooper and a great running back like myself, Giovani Bernard. You are at Kenan Stadium right now, and if you look towards the players' tunnel, above that is the Tar Pit. On fall Saturdays, the Tar Pit gets really loud, which gives us a boost against our opponents. One of the best moments of this stadium came when, my friend here Giovani Bernard ran back a punt against our little brothers down the road, NC State, to win the game. I'll hand it over to him now. ",
        img: "<br><br><img src = './img/charlie.png' height = 30% width = 30%>",
		button: "next",		
		lat: 35.906954, 
        lng: -79.047914
      }, 
	  {
        name: "Kenan Stadium", 
        text: "<b>Gio Bernard: </b>Hey, like Mr. Justice was saying, this is a very historic stadium and I am glad to have played here. So, lets get to it. Before I can tell you where you are going next, you need to beat me in a 40 yard dash. You ready for it?<br><b> Run by XXXX",
        img: "<br><br><img src = './img/gio.png' height = 30% width = 30%>",
		button: "run",		
		lat: 35.906954, 
        lng: -79.047914
      },
